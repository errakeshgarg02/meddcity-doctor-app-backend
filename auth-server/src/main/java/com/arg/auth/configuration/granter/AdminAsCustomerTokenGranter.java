...
public class AdminAsCustomerTokenGranter extends AbstractTokenGranter {
    private static final String GRANT_TYPE = "admin_as_customer";
    ...
    public AdminAsCustomerTokenGranter(
    ...
    protected OAuth2Authentication getOAuth2Authentication(ClientDetails client,
        ...
        if (accessToken != null) {
            ...
            if (this.isEligibleToLoginAsClient(authentication)
    ...
    private boolean isEligibleToLoginAsClient(
            ...
            if (this.clientDetailsService != null) {
                try {
                    ...
                    authentication2 = new PreAuthenticatedAuthenticationToken(
                            ...
                            Collections.singleton(ROLE_ADMIN_AS_CUSTOMER));
